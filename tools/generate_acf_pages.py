...
STEP_COPY = {
    ...
    "acf-flexible-content-generator": [
        ...
        "Экспортируйте WP-шаблон и включите CSS только при необходимости.",
    ],
    "acf-field-group-generator": [
    ...
    "acf-woocommerce-product-fields": [
        ...
        "Проверьте preview, экспортируйте WP-шаблон и включите CSS только при необходимости.",
    ],
}
...
def practical_copy(page: dict[str, object]) -> tuple[str, str]:
    ...
    return (
        ...
        (
            ...
            "Фиксируйте итоговую структуру в проектной документации, чтобы следующий разработчик понимал "
            "назначение каждого поля и не удалял важные данные при обновлении шаблона."
        ),
    )
